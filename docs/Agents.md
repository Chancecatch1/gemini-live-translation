...
| Model | Code | Use |
|-------|------|-----|
| Gemini 2.5 Flash Live | `gemini-2.5-flash-native-audio-preview-12-2025` | Real-time STT |
...
Transcribe audio files (mp3, wav, m4a) with bilingual support (English + French).
**Uses Gemini File API** to support long lectures (>10 mins).
...
- **Prompt Engineering**: Optimized for **English-taught French courses**.
  - Distinguishes Instructional English vs. Target French.
  - Auto-corrects student pronunciation errors to intended French words.
